...
bool Read_Robot_Init_Position(char *Robot_File_Name)
{
  ...
  Robot_Map = new int **[Robot_Num];
  
  for( int i = 0 ; i < Robot_Num ; ++ i ){
  	Robot_Map[i] = new int *[Row_Num];
  	for( int j = 0 ; j < Row_Num ; ++ j )
  		Robot_Map[i][j] = new int [Column_Num];
  }
  
  for( int i = 0 ; i < Robot_Num ; ++ i ){
  	for( int j = 0 ; j < Row_Num ; ++ j ){
  		for( int k = 0 ; k < Column_Num ; ++ k )
  			Robot_Map[i][j][k] = Map[j][k];
	  }
  }
  ...
  for(int i=0;i<Robot_Num;i++)   
  {
	...
	Position_Status[Robot_Init_Position[i][0]][Robot_Init_Position[i][1]] = i + 10;
...
{
  Robot_Goal_To_Visit = new int *[4];  
  Robot_ShortestPath = new int *[4];
 ...
 Robot_Goal_To_Visit[0][0] = 9;
 Robot_Goal_To_Visit[0][1] = 6;
 Robot_Goal_To_Visit[0][2] = 1;
 Robot_Goal_To_Visit[0][3] = 8;
 Robot_Goal_To_Visit[0][4] = 1;
 Robot_Goal_To_Visit[0][5] = 3;
 
 Robot_Goal_To_Visit[1][0] = 9;
 Robot_Goal_To_Visit[1][1] = 4;
 Robot_Goal_To_Visit[1][2] = 1;
 Robot_Goal_To_Visit[1][3] = 2;
 Robot_Goal_To_Visit[1][4] = 1;
 Robot_Goal_To_Visit[1][5] = 7;
 
 Robot_Goal_To_Visit[2][0] = 1;
 Robot_Goal_To_Visit[2][1] = 6;
 Robot_Goal_To_Visit[2][2] = 9;
 Robot_Goal_To_Visit[2][3] = 8;
 Robot_Goal_To_Visit[2][4] = 9;
 Robot_Goal_To_Visit[2][5] = 3;
 
 
 Robot_Goal_To_Visit[3][0] = 1;
 Robot_Goal_To_Visit[3][1] = 4;
 Robot_Goal_To_Visit[3][2] = 9;
 Robot_Goal_To_Visit[3][3] = 2;
 Robot_Goal_To_Visit[3][4] = 9;
 Robot_Goal_To_Visit[3][5] = 7;
  ...
  Robot_Goal_To_Visit_Num = new int [4];  
  Robot_Status = new int [4]; 
  Robot_Wait_Time = new int[4];
  for(int i=0;i<Robot_Num;i++){
